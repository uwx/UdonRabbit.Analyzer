...
namespace UdonRabbit.Analyzer.CodeGen
{
    internal static class Program
    {
        ...
        private static async Task ModifyAnalyzerIndex(string path, int id, string title, string category, string severity)
        {
            ...
            var newLine = $"| URA{id:0000}     {link,-99} | {category} | {severity} | x |";
...
{{
    ...
    {{
        ...
        private const string HelpLinkUri = ""https://github.com/uwx/UdonRabbit.Analyzer/blob/master/docs/analyzers/URA{id:0000}.md"";
