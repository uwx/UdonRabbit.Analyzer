...
namespace UdonRabbit.Analyzer
{
    ...
    public class NotSupportNullableTypes : DiagnosticAnalyzer
    {
        ...
        private const string HelpLinkUri = "https://github.com/uwx/UdonRabbit.Analyzer/blob/master/docs/analyzers/URA0040.md";
        ...
        private static void AnalyzeNullableType(SyntaxNodeAnalysisContext context)
        {
            ...
            UdonSharpBehaviourUtility.ReportDiagnosticsIfValid(context, RuleSet, nullable);
        }
    }
}